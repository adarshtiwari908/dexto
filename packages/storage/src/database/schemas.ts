...
export const SqliteDatabaseSchema = z.strictObject(
    BaseDatabaseSchema.extend({
...
export const PostgresDatabaseSchema = z
    .strictObject(
        BaseDatabaseSchema.extend({
            ...
            url: EnvExpandedString()
                .optional()
                .describe('PostgreSQL connection URL (postgresql://...)'),
            connectionString: EnvExpandedString()
                .optional()
                .describe('PostgreSQL connection string'),
            host: z.string().optional().describe('PostgreSQL host'),
            port: z.int().positive().optional().describe('PostgreSQL port'),
