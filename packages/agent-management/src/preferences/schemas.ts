...
export const PreferenceDefaultsSchema = z.strictObject({
...
export const PreferenceSetupSchema = z.strictObject({
...
export const PreferenceSoundsSchema = z.strictObject({
    ...
    onApprovalRequired: z
        .boolean()
        .default(true)
        .describe('Play sound when tool approval is required (default: true when sounds enabled)'),
    approvalSoundFile: z
        .string()
        .min(1)
        .optional()
...
export const AgentToolPreferencesSchema = z.strictObject({
    disabled: z
...
export const GlobalPreferencesSchema = z.strictObject({
